...
DecodedSessionID = TypedDict(
    "DecodedSessionID",
    {"token": str, "username": str, "login-ip": str, "_auth_user_id": str},
)
...
RemixTreeDatetimePayload = TypedDict("RemixTreeDatetimePayload", {"$date": int})
...
explore_query = (
    Literal["*", "animations", "art", "games", "music", "stories", "tutorial"] | str
)
